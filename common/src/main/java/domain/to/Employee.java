...
public class Employee implements Serializable {
    ...
    private String role;
    private int employeeSector_id;

    public static long getSerialVersionUID() {
        return serialVersionUID;
    }

    public Employee(int employee_id, String name, String surname, String email, String login, String password, Gender gender, String specialty, String role, int employeeSector_id) {
    ...
    public int getEmployeeSector_id() {
        return employeeSector_id;
    }

    public void setEmployeeSector_id(int employeeSector_id) {
        this.employeeSector_id = employeeSector_id;
    }
    ...
    public int hashCode() {
        ...
        result = 31 * result + employeeSector_id;
        return result;
    }
